...
function Features() {
  ...
  return (
    <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
      ...
      <div className="flex items-center gap-2 text-sm text-blue-600 bg-blue-400/10 rounded-full px-6 py-1.5 mb-4">
        <Zap width={14} />
          ...
          <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
            <div className="p-6 group-hover:bg-blue-100 border border-transparent group-hover:border-blue-300 flex gap-4 rounded-xl transition-colors">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600 max-w-xs">
                  Choose from professionally designed, recruiter-approved resume templates.
                </p>
              </div>
            </div>
          </div>
          <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
            <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600 max-w-xs">
                  Improve summaries, skills, and experience sections instantly using AI.
                </p>
              </div>
            </div>
          </div>
