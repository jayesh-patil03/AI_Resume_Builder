...
function Footer() {
  return (
<>          
            <footer className="flex flex-col items-center justify-center w-full py-10 bg-gradient-to-b from-blue-300 to-blue-400 text-white/70">
                ...
                <p className="mt-4 text-center">Copyright © 2025 resume. All rights reservered.</p>
